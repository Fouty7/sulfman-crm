  ...
  return (
    <div className="notifications whiteBox shadow">
      <div className="pad20">
        ...
        <Button type="text" shape="circle" className="del-notif" style={{ backgroundColor: 'darkgreen', color: 'white' }}>
          <DeleteOutlined />
        </Button>
      </div>
      ...
      <div className="notif-list">
        {notifications.map((notification) => (
          <div href="/" key={notification.id} className="notification">
            <Button type="text" className="notif-btn" style={{ backgroundColor: 'darkgreen', color: 'white' }}>
