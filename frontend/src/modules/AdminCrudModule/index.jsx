...
function SidePanelTopContent({ config, formElements }) {
  ...
  return (
    <>
      ...
      <Space>
        <Button onClick={removeItem} type="text" icon={<DeleteOutlined />} size="small" className="customButton">
          {translate('remove')}
        </Button>
        <Button onClick={editItem} type="text" icon={<EditOutlined />} size="small" className="customButton">
          {translate('edit')}
        </Button>
        <Button onClick={updatePassword} type="text" icon={<LockOutlined />} size="small" className="customButton">
    ...
    <>
      ...
      <Row gutter={8}>
        ...
        <Col className="gutter-row" span={3}>
          <Button onClick={addNewItem} block={true} icon={<PlusOutlined />} className="customButton"></Button>
        </Col>
      </Row>
    </>
  );
