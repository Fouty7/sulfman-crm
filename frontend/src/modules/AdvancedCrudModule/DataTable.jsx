...
function AddNewItem({ config }) {
  ...
  return (
    <Button onClick={handleClick} type="primary" icon={<PlusOutlined />} className="customButton">
      {ADD_NEW_ENTITY}
    </Button>
  );
}
  ...
  return (
    <>
      <PageHeader
        ...
        ghost={true}
        extra={[
          <Button onClick={handelDataTableLoad} key={`${uniqueId()}`} icon={<RedoOutlined />} className="customButton">
            {translate('Refresh')}
          </Button>,
